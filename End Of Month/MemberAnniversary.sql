...
where suppliertransactiontype < 60000
  ...
  and transactiondate >= to_date('01/08/2017','dd/mm/yyyy')
  and transactiondate < to_date('01/09/2018','dd/mm/yyyy')
  and status < 50
union
select distinct externalmemberid, productmgrid
...
where m.externalmemberid = c.externalmemberid
  ...
  and m.anniversarydate < to_date('01/08/2018','dd/mm/yyyy')
  and to_char(m.anniversarydate, 'MM') = '08'
  and c.status = 0
