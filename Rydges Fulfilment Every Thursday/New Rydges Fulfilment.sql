...
where c.fulfilleddate >= to_date('01/07/2017','dd/mm/yyyy') 
   and c.fulfilleddate < to_date('22/02/2018','dd/mm/yyyy') 
...
select count(*)
from cardfulfilmentrequest c
where c.fulfilleddate >= to_date('01/02/2018','dd/mm/yyyy') 
   and c.fulfilleddate < to_date('22/02/2018','dd/mm/yyyy') 
   and c.packcode in (60,61)
   and (c.comments like '%BOOKING%' or c.comments like '%FROM KIOSK%');
...
select count(*)
from cardfulfilmentrequest c
where c.fulfilleddate >= to_date('15/02/2018','dd/mm/yyyy') 
   and c.fulfilleddate < to_date('22/02/2018','dd/mm/yyyy') 
   and c.packcode in (60,61)
   and (c.comments like '%BOOKING%' or c.comments like '%FROM KIOSK%');
